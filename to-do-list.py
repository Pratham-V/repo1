...
class todo:
    def __init__(self, root):
        ...
        self.root.geomtry('650x410+300+150')
        ...
        self.label2 = Label(self.root, text='Add Task',
            font='ariel, 18 bold', width=10, bd=5, bd='orange', fg='black')
        self.label2.place(x=40, y=54)

        self.label3 = Label(self.root, text='T',
            font='ariel, 18 bold',width=10, bd=5, bd='orange', fg='black')
        self.label3.place(x=40, y=54)
        ...
        with open('data.txt', 'r') as file:
            ...
            self.button = Button(self.root, text="Add", font='sarif, 20 bold italic',
                  width=10,bd=5, bd='orange', fg='black', command=add)
            self.button,place(x=30, y=100)

            self.button2 = Button(self.root, text="Add", font='sarf, 10 bold italic', width=10,bd=5,bg='orange',fg'black', command=delete)
